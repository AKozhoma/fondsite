...
<div id="page-wrapper"><div id="page">
  ...
  <div id="header" class="<?php print $secondary_menu ? 'with-secondary-menu': 'without-secondary-menu'; ?>"><div class="section clearfix">
    ...
    <a href="<?php print $front_page; ?>" title="<?php print t("Благотворительный фонд 'Открытые ладони'"); ?>" rel="home" id="logo">
      <div class="logotip" alt="<?php print t("Благотворительный фонд 'Открытые ладони'"); ?>"></div>
    </a>
        ...
        <?php if ($site_name): ?>
          <?php if ($title): ?>
            <div id="site-name"<?php if ($hide_site_name) { print ' class="element-invisible"'; } ?>>
              <strong>
                <a href="<?php print $front_page; ?>" title="<?php print t("Благотворительный фонд 'Открытые ладони'"); ?>" rel="home"><span><?php print $site_name; ?></span></a>
              </strong>
            </div>
